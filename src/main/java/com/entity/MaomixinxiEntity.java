...
public class MaomixinxiEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public MaomixinxiEntity() {
		
	}
	
	public MaomixinxiEntity(T t) {
		try {
	 ...
	 * 设置：猫咪名称
	 */
	public void setMaomimingcheng(String maomimingcheng) {
		this.maomimingcheng = maomimingcheng;
	}
	/**
	 * 获取：猫咪名称
	 */
	public String getMaomimingcheng() {
		return maomimingcheng;
	}
	/**
	 * 设置：猫咪种类
	 */
