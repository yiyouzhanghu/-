<template>
	<div class="addEdit-block">
		...
		>
			...
			<el-form-item class="textarea" v-if="type!='info'" label="适用宠物" prop="shiyongchongwu" >
				<el-input
			...
			<el-form-item v-else-if="ruleForm.shiyongchongwu" label="适用宠物" prop="shiyongchongwu" >
				<span class="text">{{ruleForm.shiyongchongwu}}</span>
			</el-form-item>
			...
			<el-form-item v-else-if="ruleForm.shangpinjieshao" label="商品介绍" prop="shangpinjieshao" >
				<span class="text" v-html="ruleForm.shangpinjieshao"></span>
			</el-form-item>
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.shangpinjieshao = this.ruleForm.shangpinjieshao.replace(reg,'../../../springbootdj912vwr/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
