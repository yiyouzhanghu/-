<template>
	<div class="add-update-preview">
		<el-form
			...
			<el-form-item class="add-item"  label="订单状态" prop="reservationstate">
				<el-select v-model="ruleForm.reservationstate" placeholder="请选择订单状态" :disabled=" false  ||ro.reservationstate" >
					<el-option
