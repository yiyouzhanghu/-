	...
	<div>
		...
		<div class="list-preview">
			...
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				...
				<el-button class="list-add-btn" v-if="btnAuth('chongwufuwu','新增')" type="primary" @click="add('/index/chongwufuwuAdd')">
...
<script>
	export default {
		...
		methods: {
			...
			async getFenlei() {
				await this.$http.get('fuwuleixing/list',{params: {sort: 'id',order: 'asc'}}).then(res => {
					if (res.data.code == 0) {
			...
			getList(page, fenlei, ref = '') {
				...
				this.$http.get(`chongwufuwu/${this.centerType?'page':'list'}`, {params: Object.assign(params, searchWhere)}).then(res => {
					if (res.data.code == 0) {
			...
			toDetail(item) {
				...
				this.$router.push({path: '/index/chongwufuwuDetail', query: params});
			},
