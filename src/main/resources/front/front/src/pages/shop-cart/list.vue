<template>
	<div :style='{"padding":"0 0 20px","margin":"0px auto","color":"#666","background":"none","width":"1200px","fontSize":"16px","position":"relative"}'>
		<div class="section-title" :style='{"padding":"0 50px 30px","margin":"20px 0","color":"#1b4955","textAlign":"center","background":"url(http://codegen.caihongy.cn/20241203/0dcbd9e05e1b4ae5966c705ff6dc23b4.png) no-repeat center bottom","width":"100%","fontSize":"32px","position":"inherit","fontWeight":"600","zIndex":"999"}'>购物车</div>
