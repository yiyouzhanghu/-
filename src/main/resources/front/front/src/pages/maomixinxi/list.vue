		...
		<div class="list-preview">
			...
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				...
				<el-form-item class="list-item">
					...
					<el-input v-model="formSearch.xinggetedian" placeholder="性格特点" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
				</el-form-item>
				<el-button class="list-search-btn" v-if=" true " type="primary" @click="getList(1, curFenlei)">
					<i class="el-icon-search"></i>
					查询
				</el-button>
				<el-button class="list-add-btn" v-if="btnAuth('maomixinxi','新增')" type="primary" @click="add('/index/maomixinxiAdd')">
			...
			<div class="list">
				<div class="list5">
					<div v-for="(item,index) in dataList" :key="index" class="list-item" @click.stop="toDetail(item)">
						...
						<div class="infoBox">
							<div class="name">{{item.maomimingcheng}}</div>
							<div class="name">性别:{{item.xingbie}}</div>
							<div class="name">状态:{{item.zhuangtai}}</div>
...
<script>
	export default {
		...
		methods: {
			...
			async getFenlei() {
				await this.$http.get('maomizhonglei/list',{params: {sort: 'id',order: 'asc'}}).then(res => {
					if (res.data.code == 0) {
						this.fenlei = res.data.data.list
					}
				});
				this.feileiColumn = 'maomizhonglei'
			},
			getList(page, fenlei, ref = '') {
				...
				if (this.formSearch.xinggetedian != '') searchWhere.xinggetedian = '%' + this.formSearch.xinggetedian + '%';
				if (this.curFenlei != '全部') searchWhere.maomizhonglei = this.curFenlei;
