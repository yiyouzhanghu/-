<template>
	<div class="add-update-preview">
		<el-form
			...
			<el-form-item class="add-item" label="人数" prop="seatnum">
				<el-input v-model="ruleForm.seatnum" 
					placeholder="人数" clearable :disabled=" false  ||ro.seatnum"></el-input>
			</el-form-item>
			<el-form-item class="add-item" label="预约日期" prop="reservationdate">
				<el-date-picker
					:disabled=" false  ||ro.reservationdate"
			...
			<el-form-item class="add-item" label="时间段" prop="timeslot">
				<el-input v-model="ruleForm.timeslot" 
					placeholder="时间段" clearable :disabled=" false  ||ro.timeslot"></el-input>
			</el-form-item>
