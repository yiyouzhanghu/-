<template>
	<div class="add-update-preview">
		<el-form
			...
			label-width="180px"
			>
			<el-form-item class="add-item" label="猫咪名称" prop="maomimingcheng">
				<el-input v-model="ruleForm.maomimingcheng" 
					placeholder="猫咪名称" clearable :disabled=" false  ||ro.maomimingcheng"></el-input>
			</el-form-item>
			<el-form-item class="add-item"  label="猫咪种类" prop="maomizhonglei">
				<el-select v-model="ruleForm.maomizhonglei" placeholder="请选择猫咪种类" :disabled=" false  ||ro.maomizhonglei" >
					<el-option
			...
			<el-form-item class="add-item"  label="是否绝育" prop="shifoujueyu">
				<el-select v-model="ruleForm.shifoujueyu" placeholder="请选择是否绝育" :disabled=" false  ||ro.shifoujueyu" >
					<el-option
			...
			<el-form-item class="add-item" label="领养条件" prop="lingyangtiaojian">
				<el-input
					type="textarea"
					:rows="8"
					placeholder="领养条件"
			...
			<el-form-item class="add-item" label="性格特点" prop="xinggetedian">
				<el-input
					type="textarea"
					:rows="8"
					placeholder="性格特点"
			...
			<el-form-item class="add-item" label="活动记录" prop="huodongjilu">
				<editor 
	...
	export default {
		...
		methods: {
			...
			init(type) {
				...
				this.$http.get('option/maomizhonglei/maomizhonglei', {emulateJSON: true}).then(res => {
					if (res.data.code == 0) {
						this.maomizhongleiOptions = res.data.data;
					}
				});
			...
			async onSubmit() {
				await this.$refs["ruleForm"].validate(async valid => {
					if(valid) {
						...
						await this.$http.post(`maomixinxi/${this.ruleForm.id?'update':this.centerType?'save':'add'}`, this.ruleForm).then(async res => {
							if (res.data.code == 0) {
								this.$message({
									message: '操作成功',
									type: 'success',
