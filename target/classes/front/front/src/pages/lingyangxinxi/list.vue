		...
		<div class="list-preview">
			...
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				...
				<el-form-item class="list-item">
					...
					<el-input v-model="formSearch.maomizhonglei" placeholder="猫咪种类" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
				</el-form-item>
				<el-form-item class="list-item">
				...
				<el-button class="list-add-btn" v-if="btnAuth('lingyangxinxi','新增')" type="primary" @click="add('/index/lingyangxinxiAdd')">
	...
	export default {
		...
		methods: {
			...
			getList(page, fenlei, ref = '') {
				...
				if (this.formSearch.maomizhonglei != '') searchWhere.maomizhonglei = '%' + this.formSearch.maomizhonglei + '%';
				...
				this.$http.get(`lingyangxinxi/${this.centerType?'page':'list'}`, {params: Object.assign(params, searchWhere)}).then(res => {
					if (res.data.code == 0) {
			...
			toDetail(item) {
				...
				this.$router.push({path: '/index/lingyangxinxiDetail', query: params});
			},
