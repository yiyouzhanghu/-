	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="人数" prop="seatnum" >
					<el-input v-model="ruleForm.seatnum" placeholder="人数" clearable  :readonly="ro.seatnum"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="人数" prop="seatnum" >
					<el-input v-model="ruleForm.seatnum" placeholder="人数" readonly></el-input>
				</el-form-item>
				...
				<el-form-item class="select" v-if="type!='info'"  label="订单状态" prop="reservationstate" >
					<el-select :disabled="ro.reservationstate" v-model="ruleForm.reservationstate" placeholder="请选择订单状态" >
						<el-option
				...
				<el-form-item v-else class="input" label="订单状态" prop="reservationstate" >
		...
		methods: {
			...
			init(id,type) {
				...
				if(this.type=='info'||this.type=='else'){
					...
					this.ruleForm.reservationstate = '已预定'; 				}
				// 获取用户信息
				this.$http({
